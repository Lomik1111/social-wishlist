...
class Reservation(Base):
    ...
    reserver_id: Mapped[uuid.UUID | None] = mapped_column(ForeignKey("users.id", ondelete="SET NULL"))
    ...
    thanks_sent: Mapped[bool] = mapped_column(Boolean, default=False)
    thanks_reaction: Mapped[str | None] = mapped_column(String(50))  # love | gift | fire | sparkle
    thanks_message: Mapped[str | None] = mapped_column(Text)
