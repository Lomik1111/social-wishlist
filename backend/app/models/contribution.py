...
from sqlalchemy import String, Text, DateTime, Numeric, ForeignKey, CheckConstraint, func
...
class Contribution(Base):
    ...
    contributor_id: Mapped[uuid.UUID | None] = mapped_column(ForeignKey("users.id", ondelete="SET NULL"))
