...
export default function CreateWishlistScreen() {
  ...
  const params = useLocalSearchParams<{ addToWishlist?: string }>();
  ...
  }, [title, description, occasion, eventDate, selectedTheme, privacy, createWishlist, router]);
  ...
  }, [step, params.addToWishlist, createdWishlistId, router]);
