...
export default function DashboardScreen() {
  ...
  const handleFabPress = useCallback(() => {
    ...
    setTimeout(() => {
      ...
      navigation.navigate('WishlistCreate');
    }, 200);
  }, [navigation]);
      ...
      >
        ...
        {featured && (
          <FeaturedCard
            ...
            onPress={() => {
              haptic.light();
              navigation.navigate('WishlistDetail', { id: featured.id });
            }}
          />
        )}
          ...
          <View style={styles.bentoRow}>
            {middle.map((w) => (
              <BentoCard
                ...
                wishlist={w}
                onPress={() => {
                  navigation.navigate('WishlistDetail', { id: w.id });
                }}
              />
            ))}
          </View>
        ...
        {compact && (
          <CompactCard
            wishlist={compact}
            onPress={() => {
              navigation.navigate('WishlistDetail', { id: compact.id });
            }}
          />
        )}
